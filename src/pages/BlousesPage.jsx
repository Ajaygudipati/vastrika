...
const blouseData = [
  {
    ...
    title: "Bridal Blouse",
    price: 999,
    image: "/Assets/blouses1.png",
    category: "Bridal",
  },
  {
    id: 2,
    title: "Partywear Blouse",
    price: 699,
  ...
  {
    id: 3,
    title: "Simple Cotton Blouse",
    price: 399,
    image: "/Assets/cotton1.jpg",
    category: "Casual",
  },
  {
    id: 4,
    title: "Office Wear Blouse",
    price: 800,
...
const BlousesPage = () => {
  ...
  const [filteredData, setFilteredData] = useState(blouseData);
  ...
  useEffect(() => {
    if (selectedCategory === "All") {
      setFilteredData(blouseData);
    } else {
      setFilteredData(
        blouseData.filter((item) => item.category === selectedCategory)
      );
    }
  }, [selectedCategory]);
  ...
  <div className="flex justify-between items-center px-4 py-2">
    ...
    <h2 className="text-xl font-semibold text-gray-800">Blouses</h2>
        ...
        {showForm && (
          ...
          >
            <div className="bg-white text-black rounded-3xl shadow-xl p-8 w-full max-w-2xl mx-auto relative">
              ...
              <h2 className="text-2xl font-bold mb-6">Customize Your Blouse</h2>
