...
const frockData = [
  {
    ...
    title: "Bridal Frock",
    price: 1499,
    image: "/Assets/bridal1.png",
    category: "Bridal",
  },
  {
    id: 2,
    title: "Partywear Frock",
    price: 899,
    image: "/Assets/partyfrock.png",
    category: "Party Wear",
  },
  {
    id: 3,
    title: "Casual Cotton Frock",
    price: 599,
    image: "/Assets/summerfrock.png",
    category: "Casual",
  },
  {
    id: 4,
    title: "Designer Frock",
    price: 1299,
    image: "/Assets/designerfrock.png",
    category: "Designer",
  },
];

const categories = ["All", "Bridal", "Party Wear", "Casual", "Designer"];

const FrocksPage = () => {
  const [selectedCategory, setSelectedCategory] = useState("All");
  const [filteredData, setFilteredData] = useState(frockData);
  ...
  useEffect(() => {
    setFilteredData(
      selectedCategory === "All"
        ? frockData
        : frockData.filter((item) => item.category === selectedCategory)
    );
  }, [selectedCategory]);
      ...
      <div className={`${showForm ? "blur-md pointer-events-none" : ""} transition duration-300`}>
        ...
        <header className="sticky top-0 bg-white z-50 border-b border-gray-200">
          ...
          <div className="flex justify-between items-center px-4 py-2">
            ...
            <h2 className="text-xl font-semibold text-gray-800">Frocks</h2>
            <div className="w-24" />
          </div>
        </header>
        ...
        {showForm && (
          ...
          >
            <div className="bg-white text-black rounded-3xl shadow-xl p-8 w-full max-w-2xl mx-auto relative">
              ...
              <h2 className="text-2xl font-bold mb-6">Customize Your Frock</h2>
